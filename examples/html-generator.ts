 ...
 *
 * Generates single-page HTML apps from natural language.
 * Uses Tailwind CSS via CDN, inline JavaScript, responsive design.
 *
 * Cell image: default (bare Node.js)
 * Output: index.html (served as preview)
 *
 * Usage:
 ...
 *   });
 *   await oncell.cells.agentRequest("project-1", "generate", { instruction: "Build a calculator" });
 */
...
export const config = {
  name: "HTML Generator",
  description: "Generates single-page HTML apps from natural language",
  image: "default",
  tier: "starter",
};
